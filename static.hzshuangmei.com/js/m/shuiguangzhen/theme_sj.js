...
XZSlide.prototype.init = function() {
    ...
    if (this.itemCount == null) {
        this.itemCount = this.slideCEle.find(".sliderItem").length;
    }
    this.slideCEle.find(".sliderItem:first").clone().appendTo(this.slideCEle);
...
$(function() {
    var slide1 = new XZSlide({
        cover: $(".zt-m1 .slideWraper"),
        container: $(".zt-m1 .sliderContainer"),
        itemCount: 3,
        itemWidth: 640,
        speed: 300,
        auto: true,

...
// tipsy, facebook css tooltips for jquery
(function (c) {
    function b(d) {
...
$(document).ready(function () {
    ...
    $('#commentform').submit(function () {
        ...
        if (edit) $('#comment').after('<input type="text" name="edit_id" id="edit_id" value="' + edit + '" css="display:none;" />');
        $.ajax({
            ...
            success: function (data) {
                ...
                new_htm = (parent == '0') ? ('\n<ol css="clear:both;" class="commentlist commentnew' + new_htm + 'ol>') : ('\n<ul class="children' + new_htm + 'ul>');
...
var protection = (function() {
    ...
    // 如果当前URL不是设定的URL，则跳转
    var url = function() {
        if (document.location.host != "xzh.hzshuangmei.com") {
            location.href = location.href.replace(document.location.host, 'xzh.hzshuangmei.com');
        }

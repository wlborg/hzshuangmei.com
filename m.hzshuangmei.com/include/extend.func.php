...
$url = $urlarray['arcurl'];
$litpic =replaceurl($row["litpic"]);
$relateproject.='<a href="'.$url.'" class="clickParameter"><img src="https://m.hzshuangmei.com'.$litpic.'" alt="'.$title.'"><span>'.$shorttitle.'</span></a>';
}
if($ns>0){
  if($ns<4){
...
$litpic =replaceurl($row["litpic"]);
$shorttitle = cn_substr($row["title"],80,0);
$repairRes.='<a href="'.$url.'" class="clickParameter"><img src="https://m.hzshuangmei.com'.$litpic.'" alt="'.$title.'"><span>'.$shorttitle.'</span></a>';
}
if($ns>0){
$repairRes=$repairRes;
}
